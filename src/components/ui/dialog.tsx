...
const dialogContentAnimationClasses = {
  /** Centered zoom + fade — default for all dialogs (no diagonal / corner entry). */
  center: 'data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95',
  /** Classic slide + zoom animation (top-left toward center). */
  slide:
...
> & {
  animation?: keyof typeof dialogContentAnimationClasses;
};

const DialogContent = React.forwardRef<
  React.ElementRef<typeof DialogPrimitive.Content>,
  DialogContentProps
>(({ className, children, animation = 'center', ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
